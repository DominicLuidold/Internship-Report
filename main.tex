...
Zum Start des Berufspraktikums Anfang Juli 2020 stand bereits fest, dass in weiterer Folge das CQRS-Pattern (was für \enquote{Command Query Responsibility Segregation} steht) zum Einsatz kommen wird, da andere Projekte der Fusonic GmbH - die primär auf C\# basieren - bereits gute Erfahrungen damit gemacht haben.
...
Die in den Abschnitten~\ref{sec:problemstellung} und \ref{sec:anforderungen} angeführten Punkte ergeben folgende Ziele, die im Verlauf des Berufspraktikums so weit wie möglich umzusetzen sind. Aufgrund von Budget- und Zeitlimitierungen findet das, wie im Abschnitt zuvor bereits erwähnt wurde, laufend statt und entspricht keiner Komplettumstellung in einem Zug.
...
\begin{itemize}
    ...
    \item Umstellung der bestehenden API Endpunkte und deren Controller auf CQRS bei Beibehaltung von möglichst viel Programmlogik
...
\vspace{3cm}
\noindent
Dornbirn, am [Tag. Monat Jahr anführen]\hfill Dominic Luidold
