...
Die hier beschriebene und beim Better Life System verwendete Herangehensweise orientiert sich am sogenannten \enquote{Git Feature Branch Workflow}. Die Entwicklung findet hierbei unabhängig vom master Branch statt und neu entwickelte Funktionalitäten und Änderungen werden gekapselt, um ein einfaches Zusammenarbeiten zu ermöglichen. Des Weiteren ist dadurch der Vorteil gegeben, dass durch den Einsatz von separaten Branches und der Verwendung von Pull Requests sichergestellt werden kann, dass der master Branch zu jedem Zeitpunkt funktionsfähigen Programmcode beinhaltet und somit für eine entsprechende Veröffentlichung oder als Ausgangspunkt herangezogen werden kann.
