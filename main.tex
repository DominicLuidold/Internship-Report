...
\section{Ausblick}
\label{sec:ausblick}
Das Better Life System befindet sich zum Zeitpunkt des Verfassens dieser Arbeit weiterhin in Entwicklung und wird voraussichtlich auch noch einige Zeit weiterentwickelt werden. Da die Umstellung auf das CQRS Pattern laufend durchgeführt wurde und noch nicht vollständig abgeschlossen ist, müssen noch weitere Teile des bestehenden Systems aktualisiert und entsprechend angepasst werden. Die entsprechende Basis wurde dafür während des Berufspraktikums geschaffen sowie projektspezifische Herangehensweisen und Standards festgelegt, auf denen weitere Funktionalitäten und Anpassungen aufgebaut werden können.

\medskip

Die Nutzung des CQRS Patterns im Vergleich zu einer gängigen Schichtenarchitektur hat sich bereits zum Zeitpunkt des Berufspraktikums und innerhalb der Fusonic GmbH bewährt und lässt sich somit auch für andere Projekte, unter Berücksichtigung der allgemeinen Vor- beziehungsweise Nachteile, empfehlen.
