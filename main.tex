...
\section{Implementierung von CQRS anhand des \enquote{ProjectContact} API Endpunktes}
...
Im Vergleich zu den \enquote{herkömmlichen} beziehungsweise bisher eingesetzten Unit Tests im BLS unterscheiden 
